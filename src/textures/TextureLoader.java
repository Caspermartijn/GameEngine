...
public class TextureLoader {
	...
	public static TextureData decodeTextureFile(SourceFile file) {
		int width = 0;
		int height = 0;
		ByteBuffer buffer = null;
		try {
			InputStream is = TextureLoader.class.getResourceAsStream(file.getPath());
	...
	protected static int createEmptyCubeMap(int size) {
	    int texID = GL11.glGenTextures();
